...
che corrisponde direttamente a un database di stato maggiore su tutti i nodi), la commissione di esecuzione per un'operazione che cancella una voce nello storage non è solo waived, a qualified refund is given; in fact, this refund is effectively paid up-front since the initial usage of a storage location costs substantially more than normal usage.
