...
\begin{description}
\item[nonce] Un valore scalare equivale al numero delle transazioni inviate dal mittente; formalmente $T_n$.
\item[gasPrice] Un valore scalare equiale al numero di Wei da pagare per unità di \textit{gas} per tutti i costi computazionali occorsi come risultato dell'esecuzione di questa transazione; formalmente $T_p$.
