...
\item[logsBloom] Il filtro a fiore composto da informazioni indicizzabili (l'indirizzo del logger ed i log topics) contenuto in ogni log entry dalla ricevuta di ogni transazione nella lista delle transazioni; formalmente $H_b$.
