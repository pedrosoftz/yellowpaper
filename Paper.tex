...
Le funzioni $L_B$ e $L_H$ sono quelle preparatorie riguardo ad un blocco e all'intestazione di un blocco. In maniera del tutto simile la funzione di preparazione della ricevuta della transazione $L_R$, sosteniamo i tipi e l'ordine della struttura per quando è richiesta la trasformazione RLP:
\begin{eqnarray}
